...
public class MainActivity extends AppCompatActivity {
    ...
    private class EarthquakeAsyncTask extends AsyncTask<String, Void, Event>{
         ...
         *
         * It is NOT okay to udpate the UI from a background thread, so we just return an
        ...
        /**
         * This method is invoke on the main UI thread after the background work has been done
         *
         * It is okay to modify the UI within this method. We take the {@link Event} object
         * (which was return from the doInBackground() method) and update the views on screen.
         */
